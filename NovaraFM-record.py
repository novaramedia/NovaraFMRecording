import argparse,configparser,datetime,os,stat,sys,threading,urllib.request

settingspath = 'C:\\Users\\Fraser\\Desktop\\NovaraMedia\\NovaraFMRecording\\'
...
def read_settings():
    settings_base_dir = settingspath
...
def record(args):
    ...
    target_dir = os.path.expandvars(settings['GLOBAL'][args.station])
